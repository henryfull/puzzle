...
func _ready():
	...
	$HSlider_Volumen_General.set_value_no_signal(GLOBAL.settings.volume.general)

	$HSlider_Volumen_Musica.set_value_no_signal(GLOBAL.settings.volume.music)
	
	$HSlider_Volumen_VFX.set_value_no_signal(GLOBAL.settings.volume.vfx)
