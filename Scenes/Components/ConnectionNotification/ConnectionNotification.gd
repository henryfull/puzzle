...
func show_success(service_name):
	message_label.text = TranslationServer.translate("notification_connected_to") + service_name
...
func show_error(service_name, error_message):
	message_label.text = TranslationServer.translate("notification_connection_error_to") % [service_name, error_message]
